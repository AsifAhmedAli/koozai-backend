...
router.post("/user-logout", authForUser, users_controller.user_logout);
...
router.post("/bind-wallet", authForUser, users_controller.bind_wallet);
...
router.post("/drive-data", authForUser, users_controller.drive_data);
...
router.post("/submit-data", authForUser, users_controller.submit_data);
...
router.get("/get-all-events", users_controller.get_all_events);
...
router.get("/admin/get-all-events", admin_controller.get_all_events);
...
router.post(
  ...
  authForAdmin,
  admin_controller.add_certificates
);
...
router.get(
  ...
  // authForAdmin,
  admin_controller.get_all_certificates
);
               ...
               // EDIT CERTIFICATE ROUTE
                 ...
                 router.put(
                  "/admin/edit-certificate/:certificate_id",
                  upload.single('certificateImage'),
                  authForAdmin,
                  admin_controller.edit_certificate
                );


               // GET SINGLE CERTIFICATE ROUTE

                 router.get(
                  "/admin/get-single-certificate/:certificate_id",
                  authForAdmin,
                  admin_controller.get_single_certificate
                );
              ...
              router.delete(
                "/admin/delete-certificate/:certificate_id",
                authForAdmin,
                admin_controller.delete_certificate
              );
...
router.put(
  "/admin/reset-withdraw-password",
  authForAdmin,
  admin_controller.reset_withdraw_password
);
...
// SET WORKING HOURS BY ADMIN

router.post(
  "/admin/set-working-hours",
  authForAdmin,
  admin_controller.set_working_hours
);
